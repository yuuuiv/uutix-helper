// ==UserScript==
// @name         UUTIX Helper (v15)
// @namespace    http://tampermonkey.net/
// @version      2026-06-23.15
// @description  分步复查：适配新版 detail/ticket/cart/trade-confirmation DOM；等待票价列表稳定；进入購物車后提交訂單，交易預覽页勾选条款并点击立即支付。
// @author       yuuuiv
// @license      MIT
...
(function () {
  ...
  function startMonitoring() {
    ...
    setAutoRunFlag(!startedOnTicketPage && !startedOnCartPage && !startedOnPreviewPage);
  ...
  function createControlPanel() {
    ...
    panel.innerHTML = `
      <div id="uutix-helper-header">
        <div id="uutix-helper-title">UUTIX v15</div>
